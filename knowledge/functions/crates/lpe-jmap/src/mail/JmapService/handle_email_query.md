---
type: Rust Method
title: handle_email_query
resource: crates/lpe-jmap/src/mail.rs#L40-L145
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) async fn handle_email_query( &self, account: &AuthenticatedAccount, arguments: Value, ) -> Result<Value>`
