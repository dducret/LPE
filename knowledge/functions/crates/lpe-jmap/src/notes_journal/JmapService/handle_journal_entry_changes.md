---
type: Rust Method
title: handle_journal_entry_changes
resource: crates/lpe-jmap/src/notes_journal.rs#L396-L414
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) async fn handle_journal_entry_changes( &self, account: &lpe_storage::AuthenticatedAccount, arguments: Value, ) -> Result<Value>`
