---
type: Rust Method
title: handle_note_query
resource: crates/lpe-jmap/src/notes_journal.rs#L64-L116
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) async fn handle_note_query( &self, account: &lpe_storage::AuthenticatedAccount, arguments: Value, ) -> Result<Value>`
