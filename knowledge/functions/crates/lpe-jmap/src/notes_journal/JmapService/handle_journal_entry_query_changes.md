---
type: Rust Method
title: handle_journal_entry_query_changes
resource: crates/lpe-jmap/src/notes_journal.rs#L355-L394
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
  - functions/crates/lpe-jmap/src/session/requested_account_id
  - functions/crates/lpe-jmap/src/notes_journal/journal_entry_matches_filter
...
`pub(crate) async fn handle_journal_entry_query_changes( &self, account: &lpe_storage::AuthenticatedAccount, arguments: Value, ) -> Result<Value>`
