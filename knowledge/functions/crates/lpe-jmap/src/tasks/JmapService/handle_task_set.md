---
type: Rust Method
title: handle_task_set
resource: crates/lpe-jmap/src/tasks.rs#L331-L432
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) async fn handle_task_set( &self, account: &AuthenticatedAccount, arguments: Value, created_ids: &mut HashMap<String, String>, ) -> Result<Value>`
