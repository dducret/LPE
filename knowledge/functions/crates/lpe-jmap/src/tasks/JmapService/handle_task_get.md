---
type: Rust Method
title: handle_task_get
resource: crates/lpe-jmap/src/tasks.rs#L178-L215
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
  - functions/crates/lpe-jmap/src/session/requested_account_id
  - functions/crates/lpe-jmap/src/tasks/task_properties
...
`pub(crate) async fn handle_task_get( &self, account: &AuthenticatedAccount, arguments: Value, ) -> Result<Value>`
