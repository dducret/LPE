---
type: Rust Method
title: handle_task_list_changes
resource: crates/lpe-jmap/src/tasks.rs#L66-L82
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) async fn handle_task_list_changes( &self, account: &AuthenticatedAccount, arguments: Value, ) -> Result<Value>`
