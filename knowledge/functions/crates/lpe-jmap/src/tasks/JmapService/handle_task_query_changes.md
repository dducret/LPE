---
type: Rust Method
title: handle_task_query_changes
resource: crates/lpe-jmap/src/tasks.rs#L277-L311
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) async fn handle_task_query_changes( &self, account: &AuthenticatedAccount, arguments: Value, ) -> Result<Value>`
