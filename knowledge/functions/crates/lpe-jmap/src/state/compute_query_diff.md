---
type: Rust Function
title: compute_query_diff
resource: crates/lpe-jmap/src/state.rs#L617-L645
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) fn compute_query_diff( previous_ids: &[String], current_ids: &[String], max_changes: Option<u64>, ) -> QueryDiff`
