---
type: Rust Method
title: handle_contact_changes
resource: crates/lpe-jmap/src/contacts.rs#L303-L319
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) async fn handle_contact_changes( &self, account: &AuthenticatedAccount, arguments: Value, ) -> Result<Value>`
