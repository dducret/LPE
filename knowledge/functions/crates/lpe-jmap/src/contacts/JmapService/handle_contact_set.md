---
type: Rust Method
title: handle_contact_set
resource: crates/lpe-jmap/src/contacts.rs#L321-L423
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) async fn handle_contact_set( &self, account: &AuthenticatedAccount, arguments: Value, created_ids: &mut HashMap<String, String>, ) -> Result<Value>`
