---
type: Rust Method
title: handle_contact_query_changes
resource: crates/lpe-jmap/src/contacts.rs#L271-L301
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) async fn handle_contact_query_changes( &self, account: &AuthenticatedAccount, arguments: Value, ) -> Result<Value>`
