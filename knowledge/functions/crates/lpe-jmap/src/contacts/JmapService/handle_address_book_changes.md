---
type: Rust Method
title: handle_address_book_changes
resource: crates/lpe-jmap/src/contacts.rs#L148-L174
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) async fn handle_address_book_changes( &self, account: &AuthenticatedAccount, arguments: Value, ) -> Result<Value>`
