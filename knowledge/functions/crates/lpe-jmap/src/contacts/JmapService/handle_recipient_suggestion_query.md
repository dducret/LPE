---
type: Rust Method
title: handle_recipient_suggestion_query
resource: crates/lpe-jmap/src/contacts.rs#L425-L471
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) async fn handle_recipient_suggestion_query( &self, account: &AuthenticatedAccount, arguments: Value, ) -> Result<Value>`
