---
type: Rust Method
title: calendar_attachments_by_event
resource: crates/lpe-jmap/src/calendar.rs#L639-L657
visibility: private
generated:
  by: okf-rs/0.3.0
relationships:
...
`async fn calendar_attachments_by_event( &self, account_id: Uuid, events: &[AccessibleEvent], include: bool, ) -> Result<HashMap<Uuid, Vec<CalendarEventAttachment>>>`
