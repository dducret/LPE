---
type: Rust Method
title: apply_contact_sync_commands
resource: crates/lpe-activesync/src/service.rs#L1174-L1267
visibility: private
generated:
  by: okf-rs/0.3.0
relationships:
...
`async fn apply_contact_sync_commands( &self, principal: &AuthenticatedPrincipal, collection_node: &WbxmlNode, ) -> Result<Vec<WbxmlNode>>`
