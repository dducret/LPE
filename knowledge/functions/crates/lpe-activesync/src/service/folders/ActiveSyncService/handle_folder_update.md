---
type: Rust Method
title: handle_folder_update
resource: crates/lpe-activesync/src/service/folders.rs#L303-L411
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
  ...
  - functions/crates/lpe-activesync/src/service/folders/folder_update_error_status
...
`pub(super) async fn handle_folder_update( &self, principal: &AuthenticatedPrincipal, device_id: &str, protocol_version: &str, request: &WbxmlNode, ) -> Result<Response>`
