---
type: Rust Method
title: contact_for_path
resource: crates/lpe-dav/src/service.rs#L420-L434
visibility: private
generated:
  by: okf-rs/0.3.0
relationships:
...
`async fn contact_for_path( &self, account_id: Uuid, path: &str, ) -> Result<Option<AccessibleContact>>`
