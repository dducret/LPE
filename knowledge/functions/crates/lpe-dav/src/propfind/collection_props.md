---
type: Rust Function
title: collection_props
resource: crates/lpe-dav/src/propfind.rs#L204-L229
visibility: private
generated:
  by: okf-rs/0.3.0
relationships:
...
`fn collection_props( display_name: &str, resource_type: &str, content_type: Option<&str>, etag: Option<String>, extra: Option<String>, ) -> String`
