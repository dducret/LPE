...
type: Rust Method
title: handle_move
resource: crates/lpe-imap/src/messages.rs#L334-L402
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
  ...
  - functions/crates/lpe-imap/src/messages/ensure_move_allowed
...
`pub(crate) async fn handle_move<W>( &mut self, tag: &str, arguments: &str, writer: &mut W, ref_kind: MessageRefKind, ) -> Result<bool> where W: AsyncWriteExt + Unpin,`
