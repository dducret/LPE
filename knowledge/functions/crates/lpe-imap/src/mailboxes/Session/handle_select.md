...
type: Rust Method
title: handle_select
resource: crates/lpe-imap/src/mailboxes.rs#L385-L395
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) async fn handle_select<W>( &mut self, tag: &str, arguments: &str, writer: &mut W, ) -> Result<bool> where W: AsyncWriteExt + Unpin,`
