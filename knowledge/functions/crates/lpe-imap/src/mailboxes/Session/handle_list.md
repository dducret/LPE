...
type: Rust Method
title: handle_list
resource: crates/lpe-imap/src/mailboxes.rs#L19-L30
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) async fn handle_list<W>( &mut self, tag: &str, arguments: &str, writer: &mut W, ) -> Result<bool> where W: AsyncWriteExt + Unpin,`
