...
type: Rust Method
title: handle_setacl
resource: crates/lpe-imap/src/acl.rs#L151-L172
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) async fn handle_setacl<W>( &mut self, tag: &str, arguments: &str, writer: &mut W, ) -> Result<bool> where W: AsyncWriteExt + Unpin,`
