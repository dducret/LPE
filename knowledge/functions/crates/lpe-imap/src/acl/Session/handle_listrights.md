---
type: Rust Method
title: handle_listrights
resource: crates/lpe-imap/src/acl.rs#L115-L149
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) async fn handle_listrights<W>( &mut self, tag: &str, arguments: &str, writer: &mut W, ) -> Result<bool> where W: AsyncWriteExt + Unpin,`
