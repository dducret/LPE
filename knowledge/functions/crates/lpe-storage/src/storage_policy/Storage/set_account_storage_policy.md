---
type: Rust Method
title: set_account_storage_policy
resource: crates/lpe-storage/src/storage_policy.rs#L235-L256
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub async fn set_account_storage_policy( &self, account_id: Uuid, update: StoragePolicyUpdate, audit: AuditEntryInput, ) -> Result<()>`
