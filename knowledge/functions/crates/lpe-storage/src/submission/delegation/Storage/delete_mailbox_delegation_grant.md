...
resource: crates/lpe-storage/src/submission/delegation.rs#L263-L324
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub async fn delete_mailbox_delegation_grant( &self, owner_account_id: Uuid, grantee_account_id: Uuid, audit: AuditEntryInput, ) -> Result<()>`
