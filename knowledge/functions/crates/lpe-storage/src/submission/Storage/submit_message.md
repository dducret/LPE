...
resource: crates/lpe-storage/src/submission.rs#L581-L940
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
  ...
  - functions/crates/lpe-storage/src/submission/types/submission_authorization_kind_sql
  - functions/crates/lpe-storage/src/submission/types/source_protocol_sql
...
`pub async fn submit_message( &self, input: SubmitMessageInput, audit: AuditEntryInput, ) -> Result<SubmittedMessage>`
