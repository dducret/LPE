...
resource: crates/lpe-storage/src/collaboration.rs#L531-L538
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub async fn fetch_accessible_contacts_in_collection( &self, principal_account_id: Uuid, collection_id: &str, ) -> Result<Vec<AccessibleContact>>`
