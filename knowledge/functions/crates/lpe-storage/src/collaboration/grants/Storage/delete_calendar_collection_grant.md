...
resource: crates/lpe-storage/src/collaboration/grants.rs#L369-L437
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub async fn delete_calendar_collection_grant( &self, owner_account_id: Uuid, calendar_collection_id: &str, grantee_account_id: Uuid, audit: AuditEntryInput, ) -> Result<()>`
