...
resource: crates/lpe-storage/src/auth.rs#L734-L774
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub async fn fetch_active_account_app_passwords( &self, account_email: &str, ) -> Result<Vec<StoredAccountAppPassword>>`
