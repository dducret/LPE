...
resource: crates/lpe-storage/src/mailboxes.rs#L1252-L1352
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub async fn destroy_jmap_mailbox( &self, account_id: Uuid, mailbox_id: Uuid, audit: AuditEntryInput, ) -> Result<()>`
