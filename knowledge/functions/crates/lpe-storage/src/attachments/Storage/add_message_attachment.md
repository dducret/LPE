...
`pub async fn add_message_attachment( &self, account_id: Uuid, message_id: Uuid, attachment: AttachmentUploadInput, audit: AuditEntryInput, ) -> Result<Option<(JmapEmail, ActiveSyncAttachment)>>`
