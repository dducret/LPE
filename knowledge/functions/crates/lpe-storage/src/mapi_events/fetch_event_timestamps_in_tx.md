---
type: Rust Function
title: fetch_event_timestamps_in_tx
resource: crates/lpe-storage/src/mapi_events.rs#L1383-L1410
visibility: private
generated:
  by: okf-rs/0.3.0
relationships:
...
`async fn fetch_event_timestamps_in_tx( tx: &mut sqlx::Transaction<'_, Postgres>, tenant_id: &Uuid, event_id: Uuid, ) -> Result<(String, String)>`
