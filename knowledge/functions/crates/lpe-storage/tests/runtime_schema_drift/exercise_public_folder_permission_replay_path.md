...
resource: crates/lpe-storage/tests/runtime_schema_drift.rs#L4712-L4980
visibility: private
generated:
  by: okf-rs/0.3.0
relationships:
...
`async fn exercise_public_folder_permission_replay_path( storage: &Storage, pool: &PgPool, fixture: &RuntimeFixture, ) -> Result<()>`
