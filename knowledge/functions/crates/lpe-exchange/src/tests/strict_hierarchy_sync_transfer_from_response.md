...
resource: crates/lpe-exchange/src/tests/mod.rs#L12796-L12813
visibility: private
generated:
  by: okf-rs/0.3.0
relationships:
...
`fn strict_hierarchy_sync_transfer_from_response( response_rops: &[u8], ) -> Result<StrictHierarchySyncStream, String>`
