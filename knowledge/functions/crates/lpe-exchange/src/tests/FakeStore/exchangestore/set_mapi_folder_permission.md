...
resource: crates/lpe-exchange/src/tests/mod.rs#L7131-L7191
visibility: private
generated:
  by: okf-rs/0.3.0
relationships:
...
`fn set_mapi_folder_permission<'a>( &'a self, owner_account_id: Uuid, mailbox_id: Uuid, grantee_account_id: Uuid, may_read: bool, may_write: bool, may_delete: bool, may_share: bool, audit: lpe_storage::AuditEntryInput, ) -> StoreFuture<'a, ()>`
