...
resource: crates/lpe-exchange/src/tests/mod.rs#L8631-L8654
visibility: private
generated:
  by: okf-rs/0.3.0
relationships:
...
`fn fetch_task_sync_versions<'a>( &'a self, _principal_account_id: Uuid, collection_id: &'a str, ) -> StoreFuture<'a, Vec<(Uuid, String)>>`
