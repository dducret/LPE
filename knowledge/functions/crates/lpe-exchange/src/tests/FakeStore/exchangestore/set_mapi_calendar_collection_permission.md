---
type: Rust Method
title: set_mapi_calendar_collection_permission
resource: crates/lpe-exchange/src/tests/mod.rs#L7309-L7370
visibility: private
generated:
  by: okf-rs/0.3.0
relationships:
...
`fn set_mapi_calendar_collection_permission<'a>( &'a self, owner_account_id: Uuid, calendar_collection_id: &'a str, grantee_account_id: Uuid, may_read: bool, may_write: bool, may_delete: bool, may_share: bool, audit: lpe_storage::AuditEntryInput, ) -> StoreFuture<'a, ()>`
