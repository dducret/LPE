...
resource: crates/lpe-exchange/src/tests/mod.rs#L15262-L15272
visibility: private
generated:
  by: okf-rs/0.3.0
relationships:
...
`fn append_search_property_tagged_string( restriction: &mut Vec<u8>, property_tag: u32, value_tag: u32, relop: u8, value: &str, )`
