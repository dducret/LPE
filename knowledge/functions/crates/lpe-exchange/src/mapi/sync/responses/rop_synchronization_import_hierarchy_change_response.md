---
type: Rust Function
title: rop_synchronization_import_hierarchy_change_response
resource: crates/lpe-exchange/src/mapi/sync/responses.rs#L78-L85
generated:
  by: okf-rs/0.3.0
relationships:
  called_by:
...
`pub(in crate::mapi) fn rop_synchronization_import_hierarchy_change_response( request: &RopRequest, ) -> Vec<u8>`
