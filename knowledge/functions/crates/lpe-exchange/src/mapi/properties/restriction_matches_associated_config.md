---
type: Rust Function
title: restriction_matches_associated_config
resource: crates/lpe-exchange/src/mapi/properties.rs#L398-L405
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(in crate::mapi) fn restriction_matches_associated_config( restriction: Option<&MapiRestriction>, message: &MapiAssociatedConfigMessage, ) -> bool`
