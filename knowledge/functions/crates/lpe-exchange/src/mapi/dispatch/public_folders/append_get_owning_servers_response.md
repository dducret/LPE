---
type: Rust Function
title: append_get_owning_servers_response
resource: crates/lpe-exchange/src/mapi/dispatch/public_folders.rs#L529-L564
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(super) fn append_get_owning_servers_response( session: &MapiSession, handle_slots: &[u32], request: &RopRequest, snapshot: &MapiMailStoreSnapshot, responses: &mut Vec<u8>, )`
