---
type: Rust Function
title: get_collapse_state_response
resource: crates/lpe-exchange/src/mapi/dispatch/tables.rs#L1936-L1941
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(super) fn get_collapse_state_response( request: &RopRequest, object: Option<&MapiObject>, ) -> Vec<u8>`
