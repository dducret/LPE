---
type: Rust Function
title: mapi_value_debug_bool
resource: crates/lpe-exchange/src/mapi/dispatch/diagnostics/values.rs#L26-L35
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(in crate::mapi::dispatch) fn mapi_value_debug_bool( properties: &HashMap<u32, MapiValue>, tag: u32, ) -> String`
