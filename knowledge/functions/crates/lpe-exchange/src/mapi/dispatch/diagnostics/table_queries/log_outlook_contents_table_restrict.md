---
type: Rust Function
title: log_outlook_contents_table_restrict
resource: crates/lpe-exchange/src/mapi/dispatch/diagnostics/table_queries.rs#L503-L574
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(in crate::mapi::dispatch) fn log_outlook_contents_table_restrict( principal: &AccountPrincipal, request: &RopRequest, object: Option<&MapiObject>, selected_named_property_context: &str, snapshot: &MapiMailStoreSnapshot, )`
