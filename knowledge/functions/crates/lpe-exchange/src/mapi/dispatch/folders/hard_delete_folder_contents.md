---
type: Rust Function
title: hard_delete_folder_contents
resource: crates/lpe-exchange/src/mapi/dispatch/folders.rs#L749-L828
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(super) async fn hard_delete_folder_contents<S: ExchangeStore>( store: &S, principal: &AccountPrincipal, folder_id: u64, mailboxes: &[JmapMailbox], emails: &[JmapEmail], snapshot: &MapiMailStoreSnapshot, ) -> Result<(Vec<u64>, bool), u32>`
