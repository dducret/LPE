---
type: Rust Function
title: stage_event_property_values
resource: crates/lpe-exchange/src/mapi/dispatch/event_transactions.rs#L61-L168
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(super) fn stage_event_property_values( session: &mut MapiSession, handle_slots: &[u32], request: &RopRequest, snapshot: &MapiMailStoreSnapshot, values: Vec<(u32, MapiValue)>, ) -> Result<Vec<(usize, u32, u32)>>`
