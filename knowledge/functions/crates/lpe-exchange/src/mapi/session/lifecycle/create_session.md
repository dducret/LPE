...
resource: crates/lpe-exchange/src/mapi/session/lifecycle.rs#L102-L167
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(in crate::mapi) fn create_session( endpoint: MapiEndpoint, principal: &AccountPrincipal, request_type: &str, request_id: &str, ) -> String`
