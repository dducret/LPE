---
type: Rust Function
title: plan_mapi_store_access
resource: crates/lpe-exchange/src/mapi/store_adapter/access_plan.rs#L31-L73
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
  - functions/crates/lpe-exchange/src/mapi/store_adapter/access_plan/MapiAccessPlan/full
...
`pub(in crate::mapi) fn plan_mapi_store_access( session: &MapiSession, rop_buffer: &[u8], ) -> MapiAccessPlan`
