---
type: Rust Function
title: sort_recoverable_items
resource: crates/lpe-exchange/src/mapi/tables/sorting.rs#L161-L196
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(in crate::mapi) fn sort_recoverable_items( rows: &mut [&crate::mapi_store::MapiRecoverableItemMessage], sort_orders: &[MapiSortOrder], )`
