---
type: Rust Function
title: sort_attachments
resource: crates/lpe-exchange/src/mapi/tables/sorting.rs#L198-L225
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(in crate::mapi) fn sort_attachments( rows: &mut [&MapiAttachment], sort_orders: &[MapiSortOrder], )`
