---
type: Rust Function
title: serialize_pending_journal_entry_row
resource: crates/lpe-exchange/src/mapi/tables/pending.rs#L191-L222
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(in crate::mapi) fn serialize_pending_journal_entry_row( principal: &AccountPrincipal, properties: &HashMap<u32, MapiValue>, columns: &[u32], ) -> Vec<u8>`
