...
resource: crates/lpe-exchange/src/mapi/tables/associated_contents.rs#L314-L321
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(super) fn associated_table_row_matches( message: &AssociatedTableRow, restriction: Option<&MapiRestriction>, _mailbox_guid: Uuid, ) -> bool`
