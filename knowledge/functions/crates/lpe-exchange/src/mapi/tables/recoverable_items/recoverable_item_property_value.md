---
type: Rust Function
title: recoverable_item_property_value
resource: crates/lpe-exchange/src/mapi/tables/recoverable_items.rs#L72-L124
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(super) fn recoverable_item_property_value( item: &crate::mapi_store::MapiRecoverableItemMessage, property_tag: u32, ) -> Option<MapiValue>`
