---
type: Rust Function
title: serialize_root_folder_row
resource: crates/lpe-exchange/src/mapi/tables/folders.rs#L590-L667
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(in crate::mapi) fn serialize_root_folder_row( _mailboxes: &[JmapMailbox], columns: &[u32], principal: Option<&AccountPrincipal>, ) -> Vec<u8>`
