---
type: Rust Function
title: rpc_proxy_nspi_get_props_response_for_principal
resource: crates/lpe-exchange/src/service/rpc_proxy_endpoints.rs#L565-L590
visibility: private
generated:
  by: okf-rs/0.3.0
relationships:
  ...
  - functions/crates/lpe-exchange/src/service/rpc_proxy_endpoints/rpc_proxy_nspi_entry_is_principal
...
`async fn rpc_proxy_nspi_get_props_response_for_principal<S>( store: &S, call_id: u32, request: &[u8], principal: &AccountPrincipal, ) -> Vec<u8> where S: ExchangeStore,`
