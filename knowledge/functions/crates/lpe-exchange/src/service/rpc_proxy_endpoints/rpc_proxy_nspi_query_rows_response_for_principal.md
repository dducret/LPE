---
type: Rust Function
title: rpc_proxy_nspi_query_rows_response_for_principal
resource: crates/lpe-exchange/src/service/rpc_proxy_endpoints.rs#L442-L463
visibility: private
generated:
  by: okf-rs/0.3.0
relationships:
...
`async fn rpc_proxy_nspi_query_rows_response_for_principal<S>( store: &S, call_id: u32, request: &[u8], principal: &AccountPrincipal, ) -> Vec<u8> where S: ExchangeStore,`
