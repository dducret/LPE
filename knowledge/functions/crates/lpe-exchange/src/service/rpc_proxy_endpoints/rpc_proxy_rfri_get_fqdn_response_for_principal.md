---
type: Rust Function
title: rpc_proxy_rfri_get_fqdn_response_for_principal
resource: crates/lpe-exchange/src/service/rpc_proxy_endpoints.rs#L346-L358
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(super) fn rpc_proxy_rfri_get_fqdn_response_for_principal( call_id: u32, endpoint_query: &str, principal: &AccountPrincipal, ) -> Vec<u8>`
