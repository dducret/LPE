---
type: Rust Function
title: rpc_proxy_rfri_get_new_dsa_response_for_principal
resource: crates/lpe-exchange/src/service/rpc_proxy_endpoints.rs#L319-L333
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
  - functions/crates/lpe-exchange/src/service/rpc_proxy_endpoints/rpc_proxy_referral_server_name_for_principal
...
`pub(super) fn rpc_proxy_rfri_get_new_dsa_response_for_principal( call_id: u32, endpoint_query: &str, principal: &AccountPrincipal, ) -> Vec<u8>`
