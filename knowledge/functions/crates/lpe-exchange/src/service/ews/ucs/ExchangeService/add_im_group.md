...
type: Rust Method
title: add_im_group
resource: crates/lpe-exchange/src/service/ews/ucs.rs#L25-L46
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(in crate::service) async fn add_im_group( &self, principal: &AccountPrincipal, request: &str, ) -> Result<String>`
