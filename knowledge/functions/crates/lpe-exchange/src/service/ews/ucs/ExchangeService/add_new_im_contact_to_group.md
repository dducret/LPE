---
type: Rust Method
title: add_new_im_contact_to_group
resource: crates/lpe-exchange/src/service/ews/ucs.rs#L121-L174
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(in crate::service) async fn add_new_im_contact_to_group( &self, principal: &AccountPrincipal, request: &str, ) -> Result<String>`
