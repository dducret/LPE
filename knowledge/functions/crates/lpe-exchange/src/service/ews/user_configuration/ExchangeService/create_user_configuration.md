---
type: Rust Method
title: create_user_configuration
resource: crates/lpe-exchange/src/service/ews/user_configuration.rs#L39-L73
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(in crate::service) async fn create_user_configuration( &self, principal: &AccountPrincipal, request: &str, ) -> Result<String>`
