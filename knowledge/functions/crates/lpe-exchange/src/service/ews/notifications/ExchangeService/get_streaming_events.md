---
type: Rust Method
title: get_streaming_events
resource: crates/lpe-exchange/src/service/ews/notifications.rs#L46-L64
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(in crate::service) async fn get_streaming_events( &self, principal: &AccountPrincipal, request: &str, ) -> Result<String>`
