...
resource: crates/lpe-exchange/src/service/ews/folders.rs#L83-L163
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(in crate::service) async fn sync_folder_hierarchy( &self, principal: &AccountPrincipal, ) -> Result<String>`
