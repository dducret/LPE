...
type: Rust Method
title: add_delegate
resource: crates/lpe-exchange/src/service/ews/delegation.rs#L8-L42
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(in crate::service) async fn add_delegate( &self, principal: &AccountPrincipal, request: &str, ) -> Result<String>`
