...
type: Rust Method
title: upload_items
resource: crates/lpe-exchange/src/service/ews/bulk_transfer.rs#L8-L36
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(in crate::service) async fn upload_items( &self, principal: &AccountPrincipal, request: &str, ) -> Result<String>`
