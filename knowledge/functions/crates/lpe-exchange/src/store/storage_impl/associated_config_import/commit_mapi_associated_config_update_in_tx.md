---
type: Rust Function
title: commit_mapi_associated_config_update_in_tx
resource: crates/lpe-exchange/src/store/storage_impl/associated_config_import.rs#L138-L233
visibility: private
generated:
  by: okf-rs/0.3.0
relationships:
...
`async fn commit_mapi_associated_config_update_in_tx( tx: &mut sqlx::Transaction<'_, sqlx::Postgres>, tenant_id: Uuid, input: UpsertMapiAssociatedConfigInput, ) -> Result<MapiAssociatedConfigCommit>`
