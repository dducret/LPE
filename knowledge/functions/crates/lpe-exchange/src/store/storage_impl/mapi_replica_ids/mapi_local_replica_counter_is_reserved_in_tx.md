---
type: Rust Function
title: mapi_local_replica_counter_is_reserved_in_tx
resource: crates/lpe-exchange/src/store/storage_impl/mapi_replica_ids.rs#L168-L196
visibility: private
generated:
  by: okf-rs/0.3.0
relationships:
...
`async fn mapi_local_replica_counter_is_reserved_in_tx( tx: &mut sqlx::Transaction<'_, sqlx::Postgres>, tenant_id: Uuid, account_id: Uuid, replica_guid: Uuid, global_counter: u64, ) -> Result<bool>`
