---
type: Rust Function
title: update_domain_storage_policy
resource: crates/lpe-admin-api/src/storage.rs#L234-L263
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) async fn update_domain_storage_policy( State(storage): State<Storage>, headers: HeaderMap, AxumPath(domain_id): AxumPath<Uuid>, Json(request): Json<UpdateStoragePolicyRequest>, ) -> ApiResult<StoragePolicyOverview>`
