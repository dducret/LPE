...
resource: crates/lpe-admin-api/src/workspace/mailbox_access.rs#L36-L52
generated:
  by: okf-rs/0.3.0
relationships:
  called_by:
  ...
  - functions/crates/lpe-admin-api/src/workspace/tests/delegated_mailbox_access_requires_a_canonical_grant
---

# Signature

`pub(crate) async fn resolve_client_mailbox_access<S: super::ClientSubmissionStore>( storage: &S, account: &AuthenticatedAccount, requested_account_id: Uuid, ) -> std::result::Result<MailboxAccountAccess, (StatusCode, String)>`
