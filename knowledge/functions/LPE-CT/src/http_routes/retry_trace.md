...
type: Rust Function
title: retry_trace
resource: LPE-CT/src/http_routes.rs#L265-L290
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) async fn retry_trace( State(state): State<AppState>, headers: HeaderMap, AxumPath(trace_id): AxumPath<String>, ) -> Result<Json<smtp::TraceActionResult>, ApiError>`
