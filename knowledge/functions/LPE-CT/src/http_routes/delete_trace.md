...
type: Rust Function
title: delete_trace
resource: LPE-CT/src/http_routes.rs#L319-L347
generated:
  by: okf-rs/0.3.0
relationships:
  calls:
...
`pub(crate) async fn delete_trace( State(state): State<AppState>, headers: HeaderMap, AxumPath(trace_id): AxumPath<String>, ) -> Result<Json<smtp::TraceActionResult>, ApiError>`
