...
resource: crates/lpe-exchange/src/mapi/dispatch/sync_import_message.rs#L1-L631
generated:
  by: okf-rs/0.3.0
relationships:
  imports:
  - external/super
  - external/lpe-storage-mapicontactimportedidentity
  member_of:
...
- `super::*`
- `lpe_storage::MapiContactImportedIdentity`
