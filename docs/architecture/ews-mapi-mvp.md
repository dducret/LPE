...
request bodies. Microsoft RCA "Correlation ID" values are generated by RCA and
are not guaranteed to appear in inbound requests, so operators should correlate
by timestamp plus Outlook request identifiers.
