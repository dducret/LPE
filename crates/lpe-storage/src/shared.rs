...
pub(crate) const SUGGESTED_CONTACTS_COLLECTION_ID: &str = "suggested_contacts";
pub(crate) const QUICK_CONTACTS_COLLECTION_ID: &str = "quick_contacts";
pub(crate) const IM_CONTACT_LIST_COLLECTION_ID: &str = "im_contact_list";
pub(crate) const DEFAULT_CONTACT_BOOK_ROLE: &str = "contacts";
pub(crate) const SUGGESTED_CONTACTS_ROLE: &str = "suggested_contacts";
pub(crate) const QUICK_CONTACTS_ROLE: &str = "quick_contacts";
pub(crate) const IM_CONTACT_LIST_ROLE: &str = "im_contact_list";
...
pub(crate) const EXPECTED_SCHEMA_VERSION: &str = "0.5.1-sql";
