...
pub(crate) struct ClientContactRow {
    ...
    pub(crate) phonetic_family_name: String,
    pub(crate) emails_json: Value,
    pub(crate) phones_json: Value,
    pub(crate) addresses_json: Value,
    pub(crate) urls_json: Value,
    pub(crate) photo_data: Option<String>,
    pub(crate) photo_content_type: Option<String>,
    pub(crate) categories_json: Value,
    pub(crate) birthday: Option<String>,
    pub(crate) anniversary: Option<String>,
    pub(crate) children_json: Value,
    pub(crate) spouse: String,
    pub(crate) assistant_name: String,
    pub(crate) assistant_phone: String,
    pub(crate) organization_name: String,
    pub(crate) job_title: String,
    pub(crate) raw_vcard: Option<String>,
