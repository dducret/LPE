...
use types::{
    ...
    shared_collection_display_name, shared_collection_id_for_row,
};
        ...
        let contact = self
            .upsert_client_contact_in_book_role(
                UpsertClientContactInput {
                    ...
                    photo_content_type: input.photo_content_type,
                    categories_json: input.categories_json,
                    birthday: input.birthday,
                    anniversary: input.anniversary,
                    children_json: input.children_json,
                    spouse: input.spouse,
