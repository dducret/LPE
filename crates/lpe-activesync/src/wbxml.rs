...
fn token_for(page: WbxmlCodePage, name: &str) -> Option<u8> {
    ...
    match (page, name) {
        ...
        (Contacts, "Anniversary") => Some(0x05),
        (Contacts, "AssistantName") => Some(0x06),
        (Contacts, "AssistantPhoneNumber") => Some(0x07),
        (Contacts, "Birthday") => Some(0x08),
        (Contacts, "Body") => Some(0x09),
        (Contacts, "BusinessAddressCity") => Some(0x0D),
        (Contacts, "BusinessAddressCountry") => Some(0x0E),
        (Contacts, "BusinessAddressPostalCode") => Some(0x0F),
        (Contacts, "BusinessAddressState") => Some(0x10),
        (Contacts, "BusinessAddressStreet") => Some(0x11),
        (Contacts, "BusinessPhoneNumber") => Some(0x13),
        (Contacts, "Business2PhoneNumber") => Some(0x0C),
        (Contacts, "Categories") => Some(0x15),
        (Contacts, "Category") => Some(0x16),
        (Contacts, "Children") => Some(0x17),
        (Contacts, "Child") => Some(0x18),
        (Contacts, "CompanyName") => Some(0x19),
        (Contacts, "Email1Address") => Some(0x1B),
        (Contacts, "Email2Address") => Some(0x1C),
        (Contacts, "Email3Address") => Some(0x1D),
        (Contacts, "FileAs") => Some(0x1E),
        (Contacts, "FirstName") => Some(0x1F),
        (Contacts, "HomeAddressCity") => Some(0x21),
        (Contacts, "HomeAddressCountry") => Some(0x22),
        (Contacts, "HomeAddressPostalCode") => Some(0x23),
        (Contacts, "HomeAddressState") => Some(0x24),
        (Contacts, "HomeAddressStreet") => Some(0x25),
        (Contacts, "HomePhoneNumber") => Some(0x27),
        (Contacts, "Home2PhoneNumber") => Some(0x20),
        (Contacts, "JobTitle") => Some(0x28),
        (Contacts, "LastName") => Some(0x29),
        (Contacts, "MobilePhoneNumber") => Some(0x2B),
        (Contacts, "OtherAddressCity") => Some(0x2D),
        (Contacts, "OtherAddressCountry") => Some(0x2E),
        (Contacts, "OtherAddressPostalCode") => Some(0x2F),
        (Contacts, "OtherAddressState") => Some(0x30),
        (Contacts, "OtherAddressStreet") => Some(0x31),
        (Contacts, "Picture") => Some(0x3C),
        (Contacts, "Spouse") => Some(0x34),
        (Contacts, "WebPage") => Some(0x37),
...
fn name_for(page: WbxmlCodePage, token: u8) -> Option<&'static str> {
    ...
    match (page, token) {
        ...
        (Contacts, 0x05) => Some("Anniversary"),
        (Contacts, 0x06) => Some("AssistantName"),
        (Contacts, 0x07) => Some("AssistantPhoneNumber"),
        (Contacts, 0x08) => Some("Birthday"),
        (Contacts, 0x09) => Some("Body"),
        (Contacts, 0x0D) => Some("BusinessAddressCity"),
        (Contacts, 0x0E) => Some("BusinessAddressCountry"),
        (Contacts, 0x0F) => Some("BusinessAddressPostalCode"),
        (Contacts, 0x10) => Some("BusinessAddressState"),
        (Contacts, 0x11) => Some("BusinessAddressStreet"),
        (Contacts, 0x13) => Some("BusinessPhoneNumber"),
        (Contacts, 0x0C) => Some("Business2PhoneNumber"),
        (Contacts, 0x15) => Some("Categories"),
        (Contacts, 0x16) => Some("Category"),
        (Contacts, 0x17) => Some("Children"),
        (Contacts, 0x18) => Some("Child"),
        (Contacts, 0x19) => Some("CompanyName"),
        (Contacts, 0x1B) => Some("Email1Address"),
        (Contacts, 0x1C) => Some("Email2Address"),
        (Contacts, 0x1D) => Some("Email3Address"),
        (Contacts, 0x1E) => Some("FileAs"),
        (Contacts, 0x1F) => Some("FirstName"),
        (Contacts, 0x21) => Some("HomeAddressCity"),
        (Contacts, 0x22) => Some("HomeAddressCountry"),
        (Contacts, 0x23) => Some("HomeAddressPostalCode"),
        (Contacts, 0x24) => Some("HomeAddressState"),
        (Contacts, 0x25) => Some("HomeAddressStreet"),
        (Contacts, 0x27) => Some("HomePhoneNumber"),
        (Contacts, 0x20) => Some("Home2PhoneNumber"),
        (Contacts, 0x28) => Some("JobTitle"),
        (Contacts, 0x29) => Some("LastName"),
        (Contacts, 0x2B) => Some("MobilePhoneNumber"),
        (Contacts, 0x2D) => Some("OtherAddressCity"),
        (Contacts, 0x2E) => Some("OtherAddressCountry"),
        (Contacts, 0x2F) => Some("OtherAddressPostalCode"),
        (Contacts, 0x30) => Some("OtherAddressState"),
        (Contacts, 0x31) => Some("OtherAddressStreet"),
        (Contacts, 0x3C) => Some("Picture"),
        (Contacts, 0x34) => Some("Spouse"),
        (Contacts, 0x37) => Some("WebPage"),
