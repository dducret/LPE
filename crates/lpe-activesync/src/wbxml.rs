...
fn token_for(page: u8, name: &str) -> Option<u8> {
    match (page, name) {
        ...
        (4, "Email") => Some(0x09),
        (4, "Name") => Some(0x0A),
        (4, "BusyStatus") => Some(0x0D),
        (4, "EndTime") => Some(0x12),
        (4, "Location") => Some(0x17),
        (4, "MeetingStatus") => Some(0x18),
        (4, "OrganizerEmail") => Some(0x19),
        (4, "OrganizerName") => Some(0x1A),
        (4, "Recurrence") => Some(0x1B),
        (4, "Type") => Some(0x1C),
        (4, "Until") => Some(0x1D),
        (4, "Occurrences") => Some(0x1E),
        (4, "Interval") => Some(0x1F),
        (4, "DayOfWeek") => Some(0x20),
        (4, "DayOfMonth") => Some(0x21),
        (4, "WeekOfMonth") => Some(0x22),
        (4, "MonthOfYear") => Some(0x23),
        (4, "Reminder") => Some(0x24),
        (4, "Subject") => Some(0x26),
        (4, "StartTime") => Some(0x27),
        (4, "UID") => Some(0x28),
        (4, "AttendeeStatus") => Some(0x29),
        (4, "AttendeeType") => Some(0x2A),
        (5, "MoveItems") => Some(0x05),
        (5, "Move") => Some(0x06),
        (5, "SrcMsgId") => Some(0x07),
        (5, "SrcFldId") => Some(0x08),
        (5, "DstFldId") => Some(0x09),
        (5, "Response") => Some(0x0A),
        (5, "Status") => Some(0x0B),
        (5, "DstMsgId") => Some(0x0C),
        (6, "GetItemEstimate") => Some(0x05),
        (6, "Collections") => Some(0x07),
        (6, "Collection") => Some(0x08),
        (6, "Class") => Some(0x09),
        (6, "CollectionId") => Some(0x0A),
        (6, "Estimate") => Some(0x0C),
        (6, "Response") => Some(0x0D),
        (6, "Status") => Some(0x0E),
        ...
        (7, "Update") => Some(0x11),
        (7, "SyncKey") => Some(0x12),
        (7, "FolderCreate") => Some(0x13),
        (7, "FolderDelete") => Some(0x14),
        (7, "FolderUpdate") => Some(0x15),
        (7, "FolderSync") => Some(0x16),
        (7, "Count") => Some(0x17),
        (13, "Ping") => Some(0x05),
        (13, "Status") => Some(0x07),
        (13, "HeartbeatInterval") => Some(0x08),
...
fn name_for(page: u8, token: u8) -> Option<&'static str> {
    match (page, token) {
        ...
        (4, 0x09) => Some("Email"),
        (4, 0x0A) => Some("Name"),
        (4, 0x0D) => Some("BusyStatus"),
        (4, 0x12) => Some("EndTime"),
        (4, 0x17) => Some("Location"),
        (4, 0x18) => Some("MeetingStatus"),
        (4, 0x19) => Some("OrganizerEmail"),
        (4, 0x1A) => Some("OrganizerName"),
        (4, 0x1B) => Some("Recurrence"),
        (4, 0x1C) => Some("Type"),
        (4, 0x1D) => Some("Until"),
        (4, 0x1E) => Some("Occurrences"),
        (4, 0x1F) => Some("Interval"),
        (4, 0x20) => Some("DayOfWeek"),
        (4, 0x21) => Some("DayOfMonth"),
        (4, 0x22) => Some("WeekOfMonth"),
        (4, 0x23) => Some("MonthOfYear"),
        (4, 0x24) => Some("Reminder"),
        (4, 0x26) => Some("Subject"),
        (4, 0x27) => Some("StartTime"),
        (4, 0x28) => Some("UID"),
        (4, 0x29) => Some("AttendeeStatus"),
        (4, 0x2A) => Some("AttendeeType"),
        (5, 0x05) => Some("MoveItems"),
        (5, 0x06) => Some("Move"),
        (5, 0x07) => Some("SrcMsgId"),
        (5, 0x08) => Some("SrcFldId"),
        (5, 0x09) => Some("DstFldId"),
        (5, 0x0A) => Some("Response"),
        (5, 0x0B) => Some("Status"),
        (5, 0x0C) => Some("DstMsgId"),
        (6, 0x05) => Some("GetItemEstimate"),
        (6, 0x07) => Some("Collections"),
        (6, 0x08) => Some("Collection"),
        (6, 0x09) => Some("Class"),
        (6, 0x0A) => Some("CollectionId"),
        (6, 0x0C) => Some("Estimate"),
        (6, 0x0D) => Some("Response"),
        (6, 0x0E) => Some("Status"),
        ...
        (7, 0x11) => Some("Update"),
        (7, 0x12) => Some("SyncKey"),
        (7, 0x13) => Some("FolderCreate"),
        (7, 0x14) => Some("FolderDelete"),
        (7, 0x15) => Some("FolderUpdate"),
        (7, 0x16) => Some("FolderSync"),
        (7, 0x17) => Some("Count"),
        (13, 0x05) => Some("Ping"),
        (13, 0x07) => Some("Status"),
        (13, 0x08) => Some("HeartbeatInterval"),
