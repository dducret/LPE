...
pub(in crate::mapi) const PID_TAG_SCHEDULE_INFO_APPOINTMENT_TOMBSTONE: u32 = 0x686A_0102;
pub(in crate::mapi) const PID_TAG_SCHEDULE_INFO_FREE_BUSY: u32 = 0x686C_0102;
...
pub(in crate::mapi) const PID_TAG_MESSAGE_TO_ME: u32 = 0x0057_000B;
pub(in crate::mapi) const PID_TAG_MESSAGE_CC_ME: u32 = 0x0058_000B;
pub(in crate::mapi) const PID_TAG_MESSAGE_RECIPIENT_ME: u32 = 0x0059_000B;
...
pub(in crate::mapi) const PID_TAG_RECEIVED_BY_SMTP_ADDRESS_W: u32 = 0x5D07_001F;
...
pub(in crate::mapi) const PID_TAG_RECEIVED_REPRESENTING_SMTP_ADDRESS_W: u32 = 0x5D08_001F;
...
pub(in crate::mapi) const PID_TAG_WLINK_GROUP_CLSID: u32 = 0x6850_0102;
...
pub(in crate::mapi) const PID_TAG_ATTACHMENT_CONTACT_PHOTO: u32 = 0x7FFF_000B;
...
pub(in crate::mapi) const PID_TAG_ADDRESS_TYPE_W: u32 = 0x3002_001F;
...
pub(in crate::mapi) const PID_TAG_BUSINESS2_TELEPHONE_NUMBER_W: u32 = 0x3A1B_001F;
...
pub(in crate::mapi) const PID_TAG_OTHER_TELEPHONE_NUMBER_W: u32 = 0x3A1F_001F;
pub(in crate::mapi) const PID_TAG_HOME2_TELEPHONE_NUMBER_W: u32 = 0x3A2F_001F;
pub(in crate::mapi) const PID_TAG_ASSISTANT_TELEPHONE_NUMBER_W: u32 = 0x3A2E_001F;
pub(in crate::mapi) const PID_TAG_ASSISTANT_W: u32 = 0x3A30_001F;
pub(in crate::mapi) const PID_TAG_WEDDING_ANNIVERSARY: u32 = 0x3A41_0040;
pub(in crate::mapi) const PID_TAG_BIRTHDAY: u32 = 0x3A42_0040;
...
pub(in crate::mapi) const PID_TAG_SPOUSE_NAME_W: u32 = 0x3A48_001F;
...
pub(in crate::mapi) const PID_TAG_CHILDRENS_NAMES_W: u32 = 0x3A58_101F;
pub(in crate::mapi) const PID_TAG_HOME_ADDRESS_CITY_W: u32 = 0x3A59_001F;
pub(in crate::mapi) const PID_TAG_HOME_ADDRESS_COUNTRY_W: u32 = 0x3A5A_001F;
pub(in crate::mapi) const PID_TAG_HOME_ADDRESS_POSTAL_CODE_W: u32 = 0x3A5B_001F;
pub(in crate::mapi) const PID_TAG_HOME_ADDRESS_STATE_W: u32 = 0x3A5C_001F;
pub(in crate::mapi) const PID_TAG_HOME_ADDRESS_STREET_W: u32 = 0x3A5D_001F;
pub(in crate::mapi) const PID_TAG_HOME_ADDRESS_PO_BOX_W: u32 = 0x3A5E_001F;
pub(in crate::mapi) const PID_TAG_OTHER_ADDRESS_CITY_W: u32 = 0x3A5F_001F;
pub(in crate::mapi) const PID_TAG_OTHER_ADDRESS_COUNTRY_W: u32 = 0x3A60_001F;
pub(in crate::mapi) const PID_TAG_OTHER_ADDRESS_POSTAL_CODE_W: u32 = 0x3A61_001F;
pub(in crate::mapi) const PID_TAG_OTHER_ADDRESS_STATE_W: u32 = 0x3A62_001F;
pub(in crate::mapi) const PID_TAG_OTHER_ADDRESS_STREET_W: u32 = 0x3A63_001F;
pub(in crate::mapi) const PID_TAG_OTHER_ADDRESS_PO_BOX_W: u32 = 0x3A64_001F;
...
pub(in crate::mapi) const PID_LID_ATTENDEE_CRITICAL_CHANGE: u32 = 0x0000_0001;
pub(in crate::mapi) const PID_LID_WHERE: u32 = 0x0000_0002;
pub(in crate::mapi) const PID_LID_IS_SILENT: u32 = 0x0000_0004;
...
pub(in crate::mapi) const PID_LID_WHERE_NAMED_ID: u16 = 0x81B6;
...
pub(in crate::mapi) const PID_LID_TASK_STATUS: u32 = 0x0000_8101;
...
pub(in crate::mapi) const PID_LID_TASK_DATE_COMPLETED: u32 = 0x0000_810F;
pub(in crate::mapi) const PID_LID_TASK_COMPLETE: u32 = 0x0000_811C;
pub(in crate::mapi) const PID_LID_TASK_F_RECURRING: u32 = 0x0000_814B;
...
pub(in crate::mapi) const PID_LID_APPOINTMENT_SEQUENCE: u32 = 0x0000_8201;
pub(in crate::mapi) const PID_LID_BUSY_STATUS: u32 = 0x0000_8205;
pub(in crate::mapi) const PID_LID_INTENDED_BUSY_STATUS: u32 = 0x0000_8224;
pub(in crate::mapi) const PID_LID_F_INVITED: u32 = 0x0000_8229;
...
pub(in crate::mapi) const PID_LID_RESPONSE_STATUS: u32 = 0x0000_8218;
pub(in crate::mapi) const PID_LID_RECURRING: u32 = 0x0000_8223;
pub(in crate::mapi) const PID_LID_OWNER_CRITICAL_CHANGE: u32 = 0x0000_001A;
pub(in crate::mapi) const PID_LID_APPOINTMENT_MESSAGE_CLASS: u32 = 0x0000_0024;
pub(in crate::mapi) const PID_LID_MEETING_TYPE: u32 = 0x0000_0026;
pub(in crate::mapi) const PID_LID_IS_EXCEPTION: u32 = 0x0000_000A;
...
pub(in crate::mapi) const PID_LID_ATTENDEE_CRITICAL_CHANGE_TAG: u32 = 0x81B5_0040;
pub(in crate::mapi) const PID_LID_WHERE_W_TAG: u32 = (PID_LID_WHERE_NAMED_ID as u32) << 16 | 0x001F;
pub(in crate::mapi) const PID_LID_IS_SILENT_TAG: u32 = 0x81E6_000B;
...
pub(in crate::mapi) const PID_LID_APPOINTMENT_SEQUENCE_TAG: u32 = 0x8201_0003;
pub(in crate::mapi) const PID_LID_BUSY_STATUS_TAG: u32 = 0x8205_0003;
pub(in crate::mapi) const PID_LID_INTENDED_BUSY_STATUS_TAG: u32 = 0x8224_0003;
pub(in crate::mapi) const PID_LID_F_INVITED_TAG: u32 = 0x8229_000B;
...
pub(in crate::mapi) const PID_LID_RESPONSE_STATUS_TAG: u32 = 0x8218_0003;
pub(in crate::mapi) const PID_LID_RECURRING_TAG: u32 = 0x8223_000B;
pub(in crate::mapi) const PID_LID_OWNER_CRITICAL_CHANGE_TAG: u32 = 0x8128_0040;
pub(in crate::mapi) const PID_LID_APPOINTMENT_MESSAGE_CLASS_W_TAG: u32 = 0x8311_001F;
pub(in crate::mapi) const PID_LID_MEETING_TYPE_TAG: u32 = 0x8314_0003;
pub(in crate::mapi) const PID_LID_IS_EXCEPTION_TAG: u32 = 0x81E4_000B;
...
pub(in crate::mapi) const PID_LID_TASK_STATUS_TAG: u32 = 0x8101_0003;
...
pub(in crate::mapi) const PID_LID_TASK_DATE_COMPLETED_TAG: u32 = 0x810F_0040;
pub(in crate::mapi) const PID_LID_TASK_COMPLETE_TAG: u32 = 0x811C_000B;
pub(in crate::mapi) const PID_LID_TASK_F_RECURRING_TAG: u32 = 0x814B_000B;
...
pub(in crate::mapi) const PID_LID_ADDRESS_BOOK_PROVIDER_EMAIL_LIST_TAG: u32 = 0x8028_1003;
pub(in crate::mapi) const PID_LID_ADDRESS_BOOK_PROVIDER_ARRAY_TYPE_TAG: u32 = 0x8029_0003;
pub(in crate::mapi) const PID_LID_HAS_PICTURE_TAG: u32 = 0x8015_000B;
pub(in crate::mapi) const PID_LID_WORK_ADDRESS_STREET_W_TAG: u32 = 0x8045_001F;
pub(in crate::mapi) const PID_LID_WORK_ADDRESS_CITY_W_TAG: u32 = 0x8046_001F;
pub(in crate::mapi) const PID_LID_WORK_ADDRESS_STATE_W_TAG: u32 = 0x8047_001F;
pub(in crate::mapi) const PID_LID_WORK_ADDRESS_POSTAL_CODE_W_TAG: u32 = 0x8048_001F;
pub(in crate::mapi) const PID_LID_WORK_ADDRESS_COUNTRY_W_TAG: u32 = 0x8049_001F;
pub(in crate::mapi) const PID_LID_WORK_ADDRESS_PO_BOX_W_TAG: u32 = 0x804A_001F;
pub(in crate::mapi) const PID_LID_BIRTHDAY_LOCAL_TAG: u32 = 0x80DE_0040;
pub(in crate::mapi) const PID_LID_WEDDING_ANNIVERSARY_LOCAL_TAG: u32 = 0x80DF_0040;
