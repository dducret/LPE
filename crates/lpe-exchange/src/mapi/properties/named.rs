...
pub(super) fn well_known_named_properties() -> Vec<(u16, MapiNamedProperty)> {
    ...
    .chain(
        [
            ...
            (PID_LID_APPOINTMENT_PROPOSED_START_WHOLE, PSETID_APPOINTMENT_GUID),
            (PID_LID_APPOINTMENT_PROPOSED_END_WHOLE, PSETID_APPOINTMENT_GUID),
            (PID_LID_APPOINTMENT_COUNTER_PROPOSAL, PSETID_APPOINTMENT_GUID),
            (PID_LID_APPOINTMENT_PROPOSAL_NUMBER, PSETID_APPOINTMENT_GUID),
            (PID_LID_RESPONSE_STATUS, PSETID_APPOINTMENT_GUID),
