...
#[test]
fn inbox_associated_find_row_does_not_fabricate_default_named_view() {
...
#[test]
fn inbox_associated_named_view_find_row_returns_not_found() {
    let snapshot = MapiMailStoreSnapshot::empty();
    let columns = [
        PID_TAG_ROAMING_DATATYPES,
        PID_TAG_MESSAGE_CLASS_W,
...
#[test]
fn inbox_associated_table_omits_virtual_default_named_view_for_exact_lookup() {
    let restriction = MapiRestriction::Property {
        relop: 0x04,
        property_tag: PID_TAG_MESSAGE_CLASS_W,
...
#[test]
fn inbox_associated_table_omits_virtual_default_named_view_without_restriction() {
    let rows = associated_table_rows(
        INBOX_FOLDER_ID,
        &MapiMailStoreSnapshot::empty(),
        None,
...
#[test]
fn inbox_associated_query_rows_preserves_persisted_compact_named_view() {
    let account_id = Uuid::from_u128(0xea33944627b94a9cb0de873f03a35376);
...
#[test]
fn inbox_associated_query_rows_does_not_replace_empty_persisted_compact_named_view() {
    let account_id = Uuid::from_u128(0xea33944627b94a9cb0de873f03a35376);
