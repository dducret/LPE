...
pub(in crate::mapi) use super::identity::{
    ...
    PUBLIC_FOLDERS_ROOT_FOLDER_ID, QUICK_CONTACTS_FOLDER_ID, REMINDERS_FOLDER_ID, ROOT_FOLDER_ID,
    RSS_FEEDS_FOLDER_ID, SCHEDULE_FOLDER_ID, SEARCH_FOLDER_ID, SENT_FOLDER_ID,
