...
pub(in crate::mapi) struct MapiSession {
    ...
    pub(in crate::mapi) issued_handles: HashSet<u32>,
    ...
    pub(in crate::mapi) default_view_advertisements: HashMap<u64, DefaultViewAdvertisementState>,
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub(in crate::mapi) struct DefaultViewAdvertisementState {
    pub(in crate::mapi) owner_folder_id: u64,
    pub(in crate::mapi) view_folder_id: u64,
    pub(in crate::mapi) view_message_id: u64,
    pub(in crate::mapi) view_name: String,
    pub(in crate::mapi) request_id: String,
    pub(in crate::mapi) opened: bool,
    pub(in crate::mapi) open_request_id: String,
}
...
pub(in crate::mapi) struct PostHierarchyActionState {
    ...
    pub(in crate::mapi) inbox_normal_contents_table_find_row_observed: bool,
    pub(in crate::mapi) last_inbox_normal_contents_table_setcolumns_handle: Option<u32>,
    pub(in crate::mapi) last_inbox_normal_contents_table_query_position_handle: Option<u32>,
    pub(in crate::mapi) last_inbox_normal_contents_table_query_rows_handle: Option<u32>,
    pub(in crate::mapi) last_inbox_normal_contents_table_find_row_handle: Option<u32>,
    pub(in crate::mapi) calendar_normal_contents_table_query_rows_observed: bool,
    pub(in crate::mapi) default_view_normal_contents_table_query_rows_observed: bool,
    pub(in crate::mapi) last_calendar_normal_contents_table_query_position_handle: Option<u32>,
    pub(in crate::mapi) last_calendar_normal_contents_table_query_rows_handle: Option<u32>,
    pub(in crate::mapi) last_default_view_normal_contents_table_query_rows_handle: Option<u32>,
    pub(in crate::mapi) post_calendar_query_position_named_property_probe_count: usize,
    ...
    pub(in crate::mapi) inbox_associated_findrow_returned_content: bool,
    ...
    pub(in crate::mapi) last_inbox_normal_contents_table_query_position_context: String,
    pub(in crate::mapi) last_inbox_normal_contents_table_query_rows_context: String,
    pub(in crate::mapi) last_inbox_normal_contents_table_find_row_context: String,
    pub(in crate::mapi) last_visible_inbox_message_row_context: String,
    pub(in crate::mapi) last_visible_inbox_message_open_context: String,
    pub(in crate::mapi) last_visible_inbox_message_getprops_context: String,
    pub(in crate::mapi) visible_inbox_message_open_missing_count: usize,
    pub(in crate::mapi) visible_inbox_message_getprops_not_found_count: usize,
    pub(in crate::mapi) last_calendar_normal_contents_table_query_position_context: String,
    pub(in crate::mapi) last_calendar_normal_contents_table_query_rows_context: String,
    pub(in crate::mapi) last_default_view_normal_contents_table_query_rows_context: String,
    pub(in crate::mapi) last_default_view_folder_open_context: String,
    pub(in crate::mapi) last_default_view_folder_open_handle: Option<u32>,
    pub(in crate::mapi) last_default_view_folder_open_folder_id: Option<u64>,
    pub(in crate::mapi) last_default_view_folder_open_followed_by_query_rows: bool,
    pub(in crate::mapi) last_post_calendar_query_position_named_property_context: String,
    pub(in crate::mapi) outlook_umolk_named_property_probe_count: usize,
    pub(in crate::mapi) last_outlook_umolk_named_property_probe_context: String,
    pub(in crate::mapi) last_outlook_umolk_getprops_materialization_context: String,
    pub(in crate::mapi) outlook_umolk_getprops_not_found_count: usize,
    pub(in crate::mapi) outlook_umolk_visible_inbox_release_logged: bool,
    ...
    pub(in crate::mapi) last_inbox_notification_registration_context: String,
    ...
    pub(in crate::mapi) last_advertised_default_view_owner_folder_id: Option<u64>,
    pub(in crate::mapi) last_advertised_default_view_folder_id: Option<u64>,
    pub(in crate::mapi) last_advertised_default_view_message_id: Option<u64>,
    pub(in crate::mapi) last_advertised_default_view_name: String,
    pub(in crate::mapi) last_advertised_default_view_request_id: String,
    pub(in crate::mapi) last_advertised_default_view_opened: bool,
    pub(in crate::mapi) last_advertised_default_view_open_request_id: String,
    ...
    pub(in crate::mapi) post_common_views_notification_handoff_logged: bool,
    pub(in crate::mapi) post_common_views_inbox_open_loop_metric_logged: bool,
...
pub(in crate::mapi) enum MapiObject {
    ...
    SynchronizationSource {
        ...
        client_state_selection_enabled: bool,
