...
#[test]
fn persisted_named_view_getprops_does_not_project_missing_0e0b() {
    let principal = AccountPrincipal {
        tenant_id: Uuid::nil(),
        account_id: Uuid::nil(),
        email: "test@example.test".to_string(),
    ...
    let object = MapiObject::AssociatedConfig {
        folder_id: INBOX_FOLDER_ID,
        config_id: 0x7fff_ffff_fffb_0002,
        saved_message: Some(crate::mapi_store::MapiAssociatedConfigMessage {
            id: 0x7fff_ffff_fffb_0002,
            folder_id: INBOX_FOLDER_ID,
...
#[test]
pub(in crate::mapi) fn outlook_sync_import_deletes_consumes_multibinary_source_keys() {
    // Outlook 16.0.20131 request captured on 2026-07-14. [MS-OXCROPS] section
    // 2.2.13.5.1 and [MS-OXCFXICS] section 2.2.3.2.4.5.1 require one
    // PtypMultipleBinary TaggedPropertyValue containing the deleted GIDs.
    let golden = [
        0x74, 0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x11, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x16,
        0x00, 0x74, 0x1f, 0x6f, 0xd3, 0x8e, 0x1a, 0x65, 0x4f, 0x9d, 0x42, 0x2d, 0xfb, 0x45, 0x1c,
        0x8f, 0x10, 0xa0, 0x0a, 0x52, 0x07, 0x32, 0x16, 0x16, 0x00, 0x74, 0x1f, 0x6f, 0xd3, 0x8e,
        0x1a, 0x65, 0x4f, 0x9d, 0x42, 0x2d, 0xfb, 0x45, 0x1c, 0x8f, 0x10, 0xa0, 0x0a, 0x52, 0x07,
        0x32, 0x18, 0x16, 0x00, 0x74, 0x1f, 0x6f, 0xd3, 0x8e, 0x1a, 0x65, 0x4f, 0x9d, 0x42, 0x2d,
        0xfb, 0x45, 0x1c, 0x8f, 0x10, 0xa0, 0x0a, 0x52, 0x07, 0x32, 0x19,
    ];
    let mut cursor = Cursor::new(&golden);
    ...
    assert_eq!(request.import_delete_source_keys().len(), 3);
    assert_eq!(cursor.remaining(), 0);
}
