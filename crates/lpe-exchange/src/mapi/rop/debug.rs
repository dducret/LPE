...
pub(in crate::mapi) fn property_tag_debug_name(tag: u32) -> &'static str {
    match tag {
        ...
        PID_TAG_MESSAGE_TO_ME => "PidTagMessageToMe",
        PID_TAG_MESSAGE_CC_ME => "PidTagMessageCcMe",
        PID_TAG_MESSAGE_RECIPIENT_ME => "PidTagMessageRecipientMe",
        ...
        PID_TAG_RECEIVED_BY_SMTP_ADDRESS_W => "PidTagReceivedBySmtpAddress",
        ...
        PID_TAG_RECEIVED_REPRESENTING_SMTP_ADDRESS_W => "PidTagReceivedRepresentingSmtpAddress",
        ...
        PID_LID_TASK_STATUS_TAG => "PidLidTaskStatus",
        PID_LID_TASK_START_DATE_TAG => "PidLidTaskStartDate",
        PID_LID_TASK_DUE_DATE_TAG => "PidLidTaskDueDate",
        PID_LID_TASK_DATE_COMPLETED_TAG => "PidLidTaskDateCompleted",
        PID_LID_TASK_COMPLETE_TAG => "PidLidTaskComplete",
        PID_LID_TASK_F_RECURRING_TAG => "PidLidTaskFRecurring",
        ...
        PID_LID_RESPONSE_STATUS_TAG => "PidLidResponseStatus",
