async fn commit_mapi_associated_config_create_in_tx(
    tx: &mut sqlx::Transaction<'_, sqlx::Postgres>,
    tenant_id: Uuid,
    mut input: UpsertMapiAssociatedConfigInput,
    ...
    if special_folder_alias_collision {
        anyhow::bail!("native associated config identity collides with a special-folder alias");
    }
