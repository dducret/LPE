...
impl MapiIdentityObjectKind {
    pub(crate) fn as_str(self) -> &'static str {
        match self {
            ...
            Self::DeletedCalendarEvent => "deleted_calendar_event",
            Self::Task => "task",
            Self::Note => "note",
...
pub(crate) struct MapiSyncChangeSet {
    ...
    pub(crate) changed_deleted_calendar_event_ids: Vec<Uuid>,
    ...
    pub(crate) deleted_calendar_event_object_ids: Vec<u64>,
    pub(crate) deleted_deleted_calendar_event_ids: Vec<Uuid>,
...
impl Default for MapiSyncChangeSet {
    fn default() -> Self {
        Self {
            ...
            changed_deleted_calendar_event_ids: Vec::new(),
            ...
            deleted_calendar_event_object_ids: Vec::new(),
            deleted_deleted_calendar_event_ids: Vec::new(),
