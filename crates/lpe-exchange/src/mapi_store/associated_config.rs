...
// Its leading and trailing zeroes are stream data; the following 0xFEFF in
// the capture begins the Execute response handle table.
const OUTLOOK_MINIMAL_RULE_ORGANIZER_BINARY_6802: [u8; 66] = [
    0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
