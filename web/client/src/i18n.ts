...
type Copy = {
  ...
  loginTitle: string; loginHelp: string; loginEmail: string; loginPassword: string; loginSubmit: string; loginError: string; logout: string; signedInAs: string;
  shellTabs: string[]; ribbonActions: string[]; ribbonSecondary: string[]; toolbarChips: string[]; customFolders: string[];
  favoritesLabel: string; mailboxOwner: string; folderGroups: string[]; rightPaneTitle: string;
...
const en: Copy = {
  ...
  loginTitle: "Sign in to mail", loginHelp: "Use the mailbox email address and password configured by the administrator.", loginEmail: "Email address", loginPassword: "Password", loginSubmit: "Sign in", loginError: "Invalid mailbox email or password.", logout: "Sign out", signedInAs: "Signed in as {email}",
  shellTabs: ["File", "Home", "View", "Help"], ribbonActions: ["Delete", "Archive", "Report", "Sweep", "Move to"], ribbonSecondary: ["Read / Unread", "Flag", "Pin", "Print"], toolbarChips: ["Select", "Filter", "By date"], customFolders: ["Operations", "Alerts", "Vendors", "Research"], favoritesLabel: "Favorites", mailboxOwner: "alex.meyer@lpe.example", folderGroups: ["Projects", "Customers", "Search folders"], rightPaneTitle: "Focused message",
...
const fr: Copy = {
  ...
  loginTitle: "Connexion au courrier", loginHelp: "Utilise l'adresse email de la boite et le mot de passe configure par l'administrateur.", loginEmail: "Adresse email", loginPassword: "Mot de passe", loginSubmit: "Se connecter", loginError: "Adresse email ou mot de passe invalide.", logout: "Se deconnecter", signedInAs: "Connecte en tant que {email}",
  shellTabs: ["Fichier", "Accueil", "Affichage", "Aide"], ribbonActions: ["Supprimer", "Archiver", "Signaler", "Nettoyer", "Deplacer"], ribbonSecondary: ["Lu / Non lu", "Drapeau", "Epingler", "Imprimer"], toolbarChips: ["Selection", "Filtrer", "Par date"], customFolders: ["Operations", "Alertes", "Fournisseurs", "Recherche"], favoritesLabel: "Favoris", mailboxOwner: "alex.meyer@lpe.example", folderGroups: ["Projets", "Clients", "Dossiers de recherche"], rightPaneTitle: "Message prioritaire",
