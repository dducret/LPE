...
type Copy = {
  ...
  noticeSent: string; noticeDraft: string; noticeDraftDeleted: string; noticeSyncDone: string; validationMessage: string; sendingMessage: string; sendPermissionError: string; calendarEditTitle: string; calendarCreateTitle: string; calendarActions: { new: string; save: string; create: string }; calendarFields: { date: string; time: string; title: string; location: string; attendees: string; notes: string }; noticeCalendarUpdated: string; noticeCalendarCreated: string; validationCalendar: string;
...
const en: Copy = {
  ...
  noticeSent: "Message sent.", noticeDraft: "Draft saved.", noticeDraftDeleted: "Draft deleted.", noticeSyncDone: "Mailbox refreshed.", validationMessage: "Fill at least the recipient for send, and some subject or body content.", sendingMessage: "Sending message.", sendPermissionError: "This account cannot send with the selected sender identity.",
...
const fr: Copy = {
  ...
  noticeSent: "Message envoye.", noticeDraft: "Brouillon enregistre.", noticeDraftDeleted: "Brouillon supprime.", noticeSyncDone: "Boite rechargee.", validationMessage: "Renseigne au moins le destinataire pour l'envoi, et un sujet ou du contenu.", sendingMessage: "Envoi du message.", sendPermissionError: "Ce compte ne peut pas envoyer avec cette identite d'expediteur.",
...
const de: Copy = {
  ...
  noticeSent: "Nachricht gesendet.", noticeDraft: "Entwurf gespeichert.", noticeDraftDeleted: "Entwurf geloscht.", noticeSyncDone: "Mailbox aktualisiert.", validationMessage: "Fulle fur das Senden mindestens Empfanger sowie Betreff oder Inhalt aus.", sendingMessage: "Nachricht wird gesendet.", sendPermissionError: "Dieses Konto kann nicht mit der ausgewahlten Absenderidentitat senden.",
...
const it: Copy = {
  ...
  noticeSent: "Messaggio inviato.", noticeDraft: "Bozza salvata.", noticeDraftDeleted: "Bozza eliminata.", noticeSyncDone: "Mailbox aggiornata.", validationMessage: "Compila almeno il destinatario per l'invio e un oggetto o del contenuto.", sendingMessage: "Invio del messaggio.", sendPermissionError: "Questo account non puo inviare con l'identita mittente selezionata.",
...
const es: Copy = {
  ...
  noticeSent: "Mensaje enviado.", noticeDraft: "Borrador guardado.", noticeDraftDeleted: "Borrador eliminado.", noticeSyncDone: "Mailbox actualizada.", validationMessage: "Completa al menos el destinatario para enviar y algun asunto o contenido.", sendingMessage: "Enviando mensaje.", sendPermissionError: "Esta cuenta no puede enviar con la identidad de remitente seleccionada.",
