...
function App() {
  ...
  function openNewAccountPanel() {
    ...
    setAccountPanelOpen(true);
    setAccountEditForm({ local_part: "", display_name: "", quota_mb: String(selectedDomain?.default_quota_mb ?? 4096), status: "active", password: "", gal_visibility: "tenant", directory_kind: "person" });
    setAccountTransferPath("");
    setAccountImportFile(null);
  }
