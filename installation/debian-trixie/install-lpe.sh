...
LPE_IMAP_BIND_ADDRESS_CURRENT="${LPE_IMAP_BIND_ADDRESS:-127.0.0.1:1143}"
LPE_IMAP_BIND_HOST_DEFAULT="${LPE_IMAP_BIND_HOST:-${LPE_IMAP_BIND_ADDRESS_CURRENT%:*}}"
LPE_IMAP_BIND_PORT_DEFAULT="${LPE_IMAP_BIND_PORT:-${LPE_IMAP_BIND_ADDRESS_CURRENT##*:}}"
...
LPE_AUTOCONFIG_MAPI_ENABLED_DEFAULT="${LPE_AUTOCONFIG_MAPI_ENABLED:-true}"
LPE_AUTOCONFIG_MAPI_INTEROP_GATE_PASSED_DEFAULT="${LPE_AUTOCONFIG_MAPI_INTEROP_GATE_PASSED:-false}"
LPE_AUTOCONFIG_EXCH_INTEROP_GATE_PASSED_DEFAULT="${LPE_AUTOCONFIG_EXCH_INTEROP_GATE_PASSED:-false}"
...
collect_runtime_values() {
  ...
  LPE_IMAP_BIND_HOST="$(ask_with_default "Internal IMAP host for LPE-CT" "${LPE_IMAP_BIND_HOST_DEFAULT}" validate_host_token "Enter a valid IMAP host token.")"
  LPE_IMAP_BIND_PORT="$(ask_with_default "Internal IMAP port for LPE-CT" "${LPE_IMAP_BIND_PORT_DEFAULT}" validate_port "Enter a valid IMAP TCP port.")"
  LPE_IMAP_BIND_ADDRESS="${LPE_IMAP_BIND_HOST}:${LPE_IMAP_BIND_PORT}"
  ...
  LPE_AUTOCONFIG_MAPI_ENABLED="${LPE_AUTOCONFIG_MAPI_ENABLED_DEFAULT}"
  LPE_AUTOCONFIG_MAPI_INTEROP_GATE_PASSED="${LPE_AUTOCONFIG_MAPI_INTEROP_GATE_PASSED_DEFAULT}"
  LPE_AUTOCONFIG_EXCH_INTEROP_GATE_PASSED="${LPE_AUTOCONFIG_EXCH_INTEROP_GATE_PASSED_DEFAULT}"
...
validate_runtime_values() {
  ...
  validate_host_port "${LPE_IMAP_BIND_ADDRESS:-}" || fail_install "LPE_IMAP_BIND_ADDRESS must be a host:port address."
...
write_runtime_env_file() {
  ...
  write_env_value "${ENV_FILE}" "LPE_IMAP_BIND_ADDRESS" "${LPE_IMAP_BIND_ADDRESS}"
  write_env_value "${ENV_FILE}" "LPE_IMAP_BIND_HOST" "${LPE_IMAP_BIND_HOST}"
  write_env_value "${ENV_FILE}" "LPE_IMAP_BIND_PORT" "${LPE_IMAP_BIND_PORT}"
  ...
  write_env_value "${ENV_FILE}" "LPE_AUTOCONFIG_MAPI_ENABLED" "${LPE_AUTOCONFIG_MAPI_ENABLED}"
  write_env_value "${ENV_FILE}" "LPE_AUTOCONFIG_MAPI_INTEROP_GATE_PASSED" "${LPE_AUTOCONFIG_MAPI_INTEROP_GATE_PASSED}"
  write_env_value "${ENV_FILE}" "LPE_AUTOCONFIG_EXCH_INTEROP_GATE_PASSED" "${LPE_AUTOCONFIG_EXCH_INTEROP_GATE_PASSED}"
}
